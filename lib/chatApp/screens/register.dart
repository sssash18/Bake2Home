...
import 'package:bake2home/chatApp/firebaseServices/databaseService.dart';
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () async {
                            if (fk.currentState.validate()) {
                              ...
                              dynamic rs = await _auth.registerEmailAndPassword(
                                  email, password);
                              print(rs.uid);
                              if (rs == null) {
                                setState(() {
...
//                            'email':email,
//                          });
                                DatabaseService(uid: rs.uid)
                                    .addMyUser(rs.uid, email);
                                print('user added');
                              }
                            }
                          },
