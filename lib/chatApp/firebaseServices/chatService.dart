...
class ChatService {
  ...
  sendMessage(String msg, String uid, String fid, Timestamp time, String tms,
    ...
    try {
      ...
      await PushNotification()
          .pushMessageChat('New Message from ${currentUser.name}', msg, shopMap[fid].token, uniqueid);
    } catch (e) {
      print(e.toString());
    }
  }
  ...
  startUpload(String uid, String fid, Timestamp time, String tms,
    ...
    try {
      ...
      print('cCCCCCC');
      await PushNotification().pushMessageChat(
          'New Message from ${currentUser.name}', "Photo", shopMap[fid].token, uniqueid);
    } catch (e) {
      print(e.toString());
    }
  }
